...
// Inline SVG icons to avoid unknown prop warnings from Figma inspector
...
const ChevronUpSVG = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="16"
    height="16"
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownSVG className="size-4 opacity-50" />
